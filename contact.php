    ...
    <div class="max-w-7xl mx-auto px-4">
        <div
            ...
            <div
                class="lg:col-span-4">
                <div
                    class="bg-white rounded-[40px] shadow-xl p-8 h-full flex flex-col">
                    <h2
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div
            ...
            <div
                ...
                <!-- CTA -->
                <div
                    class="bg-gradient-to-br from-primary to-primary-light text-primary p-10 lg:p-14 flex flex-col justify-center">
                    <h2
                        class="heading-font text-5xl">
                        Ready To Book?
                    </h2>
                    <p
                        class="mt-6 text-primary/80">
